  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className={twMerge(generalClass, "z-30")}
      >
        {nextItem}
      </motion.div>
      {/* Prev */}
      <motion.div
        ...
        className={twMerge(generalClass, "z-20")}
      >
        {currentItem}
      </motion.div>
      {/* Next */}
      <motion.div className={twMerge(generalClass, "z-10")}>
        {nextItem}
      </motion.div>
      {/* Trick */}
      <motion.div
        animate={controls_3}
        className={twMerge(generalClass, "relative")}
      >
        {trickItem}
      </motion.div>
      <hr
